...
(\texttt{sqry}, \texttt{ref\_tools}, \texttt{exa}); the
itemised list of issues each reviewer caught is preserved in the
v2 review packet in the repository's commit history.
